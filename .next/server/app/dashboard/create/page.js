...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4024)), "C:\\Users\\CC\\Desktop\\Ecommerce\\frontend\\app\\dashboard\\create\\page.js"],
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 88835)), "C:\\Users\\CC\\Desktop\\Ecommerce\\frontend\\app\\dashboard\\layout.js"],
          metadata: {
    ...
    const pages = ["C:\\Users\\CC\\Desktop\\Ecommerce\\frontend\\app\\dashboard\\create\\page.js"];

    

    const originalPathname = "/dashboard/create/page"
    const __next_app__ = {
    ...
    const options = {"definition":{"kind":"APP_PAGE","page":"/dashboard/create/page","pathname":"/dashboard/create","bundlePath":"app/dashboard/create/page","filename":"","appPaths":[]}}
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 77034))
...
const Form = ()=>{
    const { fetchProduct, name, setName, price, setPrice, description, setDescription, category, setCategory, setFile, media, file, uploading, quantity, brand, rating, discount, setquantity, setbrand, setrating, setdiscount, setvariants, selectedTags, setSelectedTags } = (0,react__WEBPACK_IMPORTED_MODULE_3__.useContext)(_Context_CreateProduct__WEBPACK_IMPORTED_MODULE_1__.ProductContext);
    const [Tags, setTags] = react__WEBPACK_IMPORTED_MODULE_3___default().useState([]);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(()=>{
        const res = async ()=>{
            const response = await axios__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.get("/api/tags");
    ...
    const handleTagClick = (tag)=>{
        setSelectedTags((prevTags)=>{
            ...
            return isSelected ? prevTags.filter((t)=>t.id !== tag.id) : [
                ...prevTags,
                tag
            ];
        });
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        className: "w-full h-full flex items-center justify-center flex-col bg-gray-100 relative",
        children: [
                ...
                children: [
                        ...
                        children: [
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("select", {
                                        ...
                                        children: [
                                            ...
                                            Categories.map((x, i)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("option", {
                                                    value: x.category,
                                                    children: x.category
                                                }, i))
                                        ]
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    category && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("ul", {
                                        className: "flex flex-wrap mt-2",
                                        children: Tags.filter((tag)=>tag.category === category).map((tag)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("li", {
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                        className: "w-full border border-gray-300 p-2 rounded-md mt-2 bg-white",
                                        children: selectedTags.length > 0 ? selectedTags.map((t)=>t.tag_name).join(", ") : "No tags selected"
                                    })
                                ]
                            })
                        ]
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            ...
                            !media ? uploading ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                className: "w-full",
                                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                    className: "w-full h-32 flex items-center justify-center text-gray-600 font-semibold",
                                                ...
                                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                                            className: "text-green-600 mx-1 underline",
                                                            children: "browse"
                                                        })
                                                    ]
                                                })
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        className: " flex flex-col items-center justify-center  mt-3",
                        children: uploading || !name || !category || !file || !description || !price ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                            type: "submit",
                            disabled: true,
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                    className: "absolute inset-0 w-full h-full -mt-1 rounded-lg opacity-30 bg-gradient-to-b from-transparent via-transparent to-gray-700"
                                }),
                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                    className: "relative ",
                                    children: "Create Product"
...
;// CONCATENATED MODULE: ./app/dashboard/Form.js

const proxy = (0,module_proxy.createProxy)(String.raw`C:\Users\CC\Desktop\Ecommerce\frontend\app\dashboard\Form.js`)
...
;// CONCATENATED MODULE: ./app/dashboard/create/page.js
...
/* harmony default export */ const create_page = (page);
...
var __webpack_exports__ = __webpack_require__.X(0, [2697,6675,4233,3308], () => (__webpack_exec__(68310)));
