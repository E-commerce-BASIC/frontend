                ...
                {[1, 2, 3].map((step, index) => (
                    <div key={step} className={`flex-1 flex flex-col items-center text-center `}>
                        ...
                        <div
                            ...
                            className={`flex items-center justify-center w-12 h-12 rounded-full cursor-pointer ${step === 3 && 'hidden'} ${currentStep >= step
                        ...
                        {/* Step Label */}
                        <div onClick={() => setCurrentStep(step)} className={`mt-2 text-sm ${currentStep >= step ? "font-medium" : "text-gray-400"}`}>
                            {step === 1 && 'Billing Info' || step === 2 && 'Payment' || step === 3 && 'congratulation'}
                        </div>

                        {/* Line Between Steps */}
                        {index < 2 && (
                            <div className="w-full h-1 bg-gray-200 mt-2">
                                <div className={`h-full ${currentStep > step ? "bg-[#2f4550]" : "bg-gray-200"}`}></div>
                            </div>
                        )}
                    </div>
                ))}
